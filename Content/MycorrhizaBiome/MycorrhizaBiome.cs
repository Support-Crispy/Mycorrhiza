...
{
    public class MycorrhizaBiome : ModBiome
    {
        // Select all the scenery
        public override ModWaterStyle WaterStyle => ModContent.GetInstance<MycorrhizaBiomeWaterStyle>(); // Sets a water style for when inside this biome
        public override ModSurfaceBackgroundStyle SurfaceBackgroundStyle => ModContent.GetInstance<MycorrhizaBiomeBackgroundStyle>();
		...
		*/
        ...
        public override bool IsBiomeActive(Player player)
        {
            ...
            bool b1 = ModContent.GetInstance<MycorrhizaBiomeTileCount>().mycorrhizaBlockCount >= 400;
